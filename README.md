{% include module.html image_path="_includes/IMG_0152-flower.JPG" title="Decoration from MS K." description="Some more text that will appear to the left of the image." %}
...
The evolving critical edition of the Nepalese version of the Suśrutasaṃhitā is available at the [Saktumiva website area for the Suśrutasaṃhitā](https://saktumiva.org/wiki/wujastyk/susrutasamhita/start). (A [backup server](https://206-12-96-209.cloud.computecanada.ca/dokuwiki/doku.php?id=wiki:susrutaproject:start) is also available.)

This website has been archived at [Archive-it.org](https://wayback.archive-it.org/all/20241119213757/https://sushrutaproject.org/).

You can connect with the successor project to The Suśruta Project, “Mapping a Medical Tradition: The Compendium of Suśruta in Time and Space,” at [https://sushrutaproject2.github.io](https://sushrutaproject2.github.io).
